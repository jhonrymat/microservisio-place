...
>
                    ...
                    <div class="aspect-video bg-gray-100 dark:bg-gray-800 relative overflow-hidden">
                        ...
                        >
                            <div class="bg-white dark:bg-gray-800 rounded-full p-2 shadow-lg">
                                <svg style="width: 20px; height: 20px;" class="text-gray-700 dark:text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    @else
        <div class="text-center py-12 bg-gray-50 dark:bg-gray-900 rounded-lg border-2 border-dashed border-gray-300 dark:border-gray-700">
            <svg style="width: 48px; height: 48px;" class="mx-auto text-gray-400 dark:text-gray-600 mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <p class="text-xs text-gray-400 dark:text-gray-500 mt-1">Las imágenes se descargaron durante la búsqueda inicial</p>
        </div>
    @endif
</div>
